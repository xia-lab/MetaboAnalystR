...
To perform PCA, first use *PCA.Anal*. MetaboAnalystR has the options to create a scree plot (*PlotPCAScree*), score plot (*PlotPCA2DScore* or *PlotPCA3DScore*), loadings plot (*PlotPCALoading*), and biplot (*PlotPCABiplot*). Please refer to the user manual for details about each function. To view the created 3D JSON files, there exists a few software such as E-charts (online web-tool), CanvasXpress (R package), and plotly.  
