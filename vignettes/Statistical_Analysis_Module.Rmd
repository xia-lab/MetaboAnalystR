...
Following analysis, a comprehensive report can be generated which contains a detailed description of each step performed in the R package, embedded with graphical and tabular outputs. To create the report, use the *CreatePDFReport*, and specify the user's name in quotation marks as the second argument. 
