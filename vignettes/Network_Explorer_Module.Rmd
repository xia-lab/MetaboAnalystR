...
An example set of gene and compounds lists can be found in the "data" folder of the MetaboAnalyst GitHub. 

# 2.1 Detailed steps surrounding a typical workflow are below:

In the examples below, we will first explore the gene/metabolite data in a KEGGG global metabolic network (ko01100), and then in a metabolite-disease interaction network.
