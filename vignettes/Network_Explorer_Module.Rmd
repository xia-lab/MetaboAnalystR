...
**Download the gene list** [here](http://www.metaboanalyst.ca/MetaboAnalyst/resources/data/integ_genes.txt), consisting of a list of Official Gene Symbols.
**Download the metabolite list** [here](http://www.metaboanalyst.ca/MetaboAnalyst/resources/data/integ_cmpds.txt), consisting of a list of KEGG compound IDS. 

```{r, eval=FALSE}

download.file("http://www.metaboanalyst.ca/MetaboAnalyst/resources/data/integ_genes.txt", "integ_genes.txt", "curl")

download.file("http://www.metaboanalyst.ca/MetaboAnalyst/resources/data/integ_cmpds.txt", "integ_cmpds.txt", "curl")
