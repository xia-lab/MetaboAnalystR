...
Another necessary file to download IF YOU PLAN ON MAPPING GENES is to download the MetaboAnalyst gene-database from here: . Once you unzip the file, *rename the folder to "sqlite" and create an R object named url.pre with the path to the sqlite folder. For example:
