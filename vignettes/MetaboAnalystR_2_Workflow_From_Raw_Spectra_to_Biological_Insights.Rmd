...
```{r, out.width = "70%"}
# this code is just for the vignette, do not run
# plots will be outputted to your working directory
...
mSet<-PerformPSEA(mSet, "hsa_mfn", "old", permNum = 1000)
...
```{r, eval=FALSE}
# Perform GSEA 
mSet<-SetPeakEnrichMethod(mSet, "gsea", "v1")
...
mSet<-SetPeakEnrichMethod(mSet, "integ", "v1")
mSet<-SetMummichogPval(mSet, 0.25)
