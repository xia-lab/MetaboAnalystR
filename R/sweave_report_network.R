# DEPRECATED — superseded by the package's Rmarkdown report generators.
# This file is retained as a reference copy for the public standalone
# MetaboAnalystR package and must not be modified here.
# Do not call these functions; they are kept for reference only.
...
CreateNetworkExplorerIntr <- function(){
  descr <- c("\\section{Background}\n",
             ...
             " integration of transcriptomics and metabolomics data, as well as metagenomics and metabolomics data. MetaboAnalyst 6.0 implements ", 
...
CreateNetworkExplorerInputDoc <- function(mSetObj=NA){
  ...
  descr <- c("\\section{Data Input}\n",
             ...
             "MetaboAnalyst 6.0 currently accepts only compound names, HMDB IDs, or KEGG IDs as metabolite identifiers. As well,", 
