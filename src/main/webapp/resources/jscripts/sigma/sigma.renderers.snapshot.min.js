...
(function (undefined) {
    ...
    function snapshot(params) {
        ...
        CONTEXTS.forEach(function (name) {
            ...
            if (typeof gradCol1 !== 'undefined' && typeof gradCol2 !== 'undefined') {
                    var grd = context.createLinearGradient(0, 0, 0, merged.height);
                    grd.addColorStop(0, gradCol2);
                    grd.addColorStop(1, gradCol1);
        ...
        if (quality !== 1) {
            ...
            if (typeof gradCol1 !== 'undefined' && typeof gradCol2 !== 'undefined') {
                ...
                grd.addColorStop(0, gradCol1);
                grd.addColorStop(1, gradCol2);
