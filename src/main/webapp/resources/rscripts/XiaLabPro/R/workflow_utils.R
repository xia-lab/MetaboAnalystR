...
GetImageDesc <- function(mSetObj = NA, type) {
  ...
  "rf_outlier_meta" = "<b>[Potential outliers]</b>: Up to five potential outliers flagged by the multifactor Random Forest module.",
  ...
  "pca_score2d_meta" = "<b>[Metadata PCA]</b>: PCA 2D scores plot generated by the multifactor module; each point is colored/differentiated by the selected metadata factor to highlight group separation.",
