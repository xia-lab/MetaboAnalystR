...
public class MetaStatBean implements Serializable {
    ...
    public String performPvalCombination() {
        ...
        JavaRecord.record_performPvalCombination(this);
        ...
        int res = RMetaUtils.performPvalCombination(sb.getRConnection(), metapMethod, metpSigLvl);
        if (res > 0) {
            resOK = true;
    ...
    public String performVoteCounting() {
        ...
        JavaRecord.record_performVoteCounting(this);
        ...
        int res = RMetaUtils.performVoteCounting(sb.getRConnection(), vcSigLvl, minVote);
        if (res > 0) {
            resOK = true;
    ...
    public String performDirectMerging() {
        ...
        JavaRecord.record_performDirectMerging(this);
        if (wb.isEditMode()) {
            sb.addMessage("Info", "Parameters have been updated!");
        ...
        int res = RMetaUtils.performMetaMerge(sb.getRConnection(), dmSigLvl);
        if (res > 0) {
            resOK = true;
