...
public class DatasetRow implements Serializable {
    ...
    public static String humanReadable(long bytes) {
        if (bytes < 0) return "-" + humanReadable(-bytes);
    ...
    public static DatasetRow fromResultSet(ResultSet rs) throws SQLException {
        ...
        if (idObj instanceof UUID) d.setId((UUID) idObj);
        else if (idObj != null)    d.setId(UUID.fromString(String.valueOf(idObj)));
    ...
    public void setSamplenum(int samplenum) { this.samplenum = samplenum; }
