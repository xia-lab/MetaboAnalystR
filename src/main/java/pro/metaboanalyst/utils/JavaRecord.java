...
public class JavaRecord {
    ...
    public static void record_PerformDataNormalization(NormBean nb) {
    ...
    public static void record_filterButton_action(ProcessBean pb) {
    ...
    public static void record_vcButton_action(UnivBean vb) {
    ...
    public static void record_aovButton_action(UnivBean vb) {
    ...
    public static void record_corrBtn_action(UnivBean vb) {
    ...
    public static void record_ebamBtn_action(SigVarBean sv) {
    ...
    public static void record_fcButton_action(UnivBean vb) {
    ...
    public static void record_kmButton_action(ClusterBean b) {
    ...
    public static void record_ttButton_action(UnivBean b) {
    ...
    public static void recordOplsdaAction(OPLSDABean bean) {
    ...
    public static void record_pca(PCABean pcaBean) {
    ...
    public static void record_rfBn_action(ClassificationBean b) {
    ...
    public static void record_svmBn_action(ClassificationBean b) {
    ...
    public static void record_samBtn1_action(SigVarBean b) {
    ...
    public static void record_somButton_action(ClusterBean b) {
    ...
    public static void record_updateSPLSDA(SPLSDABean s) {
    ...
    public static void record_treeButton_action(ClusterBean b) {
    ...
    public static void record_ptnBtn_action(UnivBean vb) {
    ...
    public static void record_initPCA3D(LivePCABean b) {
    ...
    public static void record_aov2Bn_action(Aov2Bean b) {
    ...
    public static void record_mdlBtn_action(AscaBean b) {
    ...
    public static void record_hm2b_action(HeatMap2Bean b) {
    ...
    public static void record_covScatterButton_action(LimmaBean b) {
    ...
    public static void record_mbButton_action(MebaBean b) {
    ...
    public static void record_metaOverviewBn_action(MetaHeatmapBean b) {
    ...
    public static void record_corBtn_action(MultiCorrBean bean) {
    ...
    public static void record_rfBn_action_time(MultiRfBean bean) {
    ...
    public static void record_performExploreAnalysis(RocAnalBean bean) {
    ...
    public static void record_updateDoseDEAnalysis(DoseResponseBean bean) {
    ...
    public static void record_performCurveFitting(DoseResponseBean bean) {
    ...
    public static void record_submitBtn_action(MsetBean bean) {
    ...
    public static void record_sspNextBn_action(MappingBean bean) {
        FunctionInfo functionInfo = new FunctionInfo(
                "SSP",
    ...
    public static void record_customButton_action(PeakCustomBean b) {
        FunctionInfo functionInfo = new FunctionInfo(
                "InitLibrary",
    ...
    public static void record_performPeaks2Fun(MummiAnalBean bean) {
        FunctionInfo functionInfo = new FunctionInfo(
                "performPeaks2Fun",
    ...
    public static void record_paBn_proceed(PathBean bean) {
        FunctionInfo functionInfo = new FunctionInfo(
                "paBn_proceed",
    ...
    public static void record_doMnetworkAnalysis(String visMode) {
        FunctionInfo functionInfo = new FunctionInfo(
                "doMnetworkAnalysis",
    ...
    public static void record_prepareNetworks() {
        FunctionInfo functionInfo = new FunctionInfo(
                "prepareNetworks",
    ...
    public static void record_computeDspcNet() {
        FunctionInfo functionInfo = new FunctionInfo(
                "computeDspcNet",
    ...
    public static void record_performPvalCombination(MetaStatBean mb) {
        FunctionInfo functionInfo = new FunctionInfo(
    ...
    public static void record_performVoteCounting(MetaStatBean mb) {
        FunctionInfo functionInfo = new FunctionInfo(
                "performVoteCounting",
    ...
    public static void record_performDirectMerging(MetaStatBean mb) {
        FunctionInfo functionInfo = new FunctionInfo(
    ...
    public static void record_prepareUpsetView(MetaLoadBean sb) {
        FunctionInfo functionInfo = new FunctionInfo(
                "prepareUpsetView",
    ...
    public static void record_performMetaPathAnalysis(MetaPathStatBean mb) {
        FunctionInfo functionInfo = new FunctionInfo(
    ...
    public static void record_performMetaPoolAnalysis(MetaPathStatBean mb) {
        FunctionInfo functionInfo = new FunctionInfo(
    ...
    public static void record_prepareMetaPathUpsetView(MetaPathLoadBean sb) {
        FunctionInfo functionInfo = new FunctionInfo(
    ...
    public static void record_goToProcessing(SpectraUploadBean sb) {
        FunctionInfo functionInfo = new FunctionInfo(
                "goToProcessing",
    ...
    public static void record_prepareSpecProc(SpectraProcessBean spb) {
        FunctionInfo functionInfo = new FunctionInfo(
                "prepareSpecProc",
    ...
    public static void record_prepareDIASpec(SpectraProcessBean spb) {
        FunctionInfo functionInfo = new FunctionInfo(
                "prepareDIASpec",
    ...
    public static void record_spectraParams(SpectraParamBean spb) {
        FunctionInfo functionInfo = new FunctionInfo(
                "spectraParamer",
                "NA",
                "Set peak parameters"
    ...
    public static void record_performDefaultUnivAnalysis_internal(RocAnalBean b) {
        FunctionInfo functionInfo = new FunctionInfo(
    ...
    public static void record_performMissingImpute(ProcessBean processBean) {
        FunctionInfo functionInfo = new FunctionInfo(
    ...
    public static void recordRCommandFunctionInfo(RConnection RC, String rCmd, String functionName) {
        try {
    ...
    public static void record_performBatchCorrection(MetaLoadBean metaLoadBean) {
        FunctionInfo functionInfo = new FunctionInfo(
