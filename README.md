...
Manually download the .tar.gz file from [here](https://github.com/jsychong/MetaboAnalystR/blob/master/MetaboAnalystR_1.0.0.3.tar.gz). The * must be replaced by what is actually downloaded and built.  
